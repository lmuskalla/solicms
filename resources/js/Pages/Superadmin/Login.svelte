...
<svelte:head>
    <title>Plattform-Anmeldung</title>
</svelte:head>
...
<div class="flex min-h-screen font-sans">
    <div class="hidden w-1/2 flex-col justify-between bg-admin-text p-12 text-white lg:flex">
        ...
        <div>
            <h1 class="text-3xl font-semibold tracking-tight">Plattform-Verwaltung.</h1>
            <p class="mt-3 max-w-sm text-white/80">Tenants anlegen, verwalten und entfernen.</p>
        </div>
    ...
    <div class="flex flex-1 items-center justify-center bg-admin-bg px-6">
        <div class="w-full max-w-sm">
            ...
            <p class="mb-8 text-sm text-admin-text-secondary">Zugang für Plattformbetreiber.</p>
            ...
            <form onsubmit={submit} class="space-y-5">
                ...
                <div>
                    <label for="password" class="mb-1.5 block text-sm font-medium text-admin-text-secondary">Passwort</label>
                    <input
                        id="password"
                        type="password"
                        bind:value={password}
