<script lang="ts">
    ...
    import sideImageUrl from '../assets/images/contact.png';
    ...
    <div class="page relative" id="page" class:scrolled-out={scrolledOut}>
        ...
        <article class="max-w-screen-lg mx-auto mt-20 px-4">
            <div class="relative">
                ...
                <div class="mt-4 relative py-4 flex flex-col lg:flex-row">
                    <div class="grow dvm-prose entry-content">
                        {#if sections.body?.value}
                            <!-- eslint-disable svelte/no-at-html-tags -->
                            {@html sanitizeHtml(sections.body.value)}
                        {/if}
                    </div>
                    <img
                        src={sideImageUrl}
